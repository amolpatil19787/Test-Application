	...
	<body>
			...
			<div class="col-md-3"></div>
				...
				<form method="post" class="form-horizontal">
				    <input type="hidden" id="userid" value="<?php echo $adminid[0]; ?>">
					...
					<div class="form-group"> 
						<center><input type="button" id="submitbtn" onclick="validateResetAdminPass(this);" class="btn btn-primary" name="reset" value="Submit"></center>
					</div>
